...
internal class AnalyticsDetailActivity : AppCompatActivity() {
    ...
    private fun getSourceColor(source: AnalyticsSource): Int {
        val colorRes = when (source) {
            AnalyticsSource.FIREBASE -> R.color.ni_warning
            AnalyticsSource.CLEVERTAP -> R.color.ni_info
            AnalyticsSource.APPSFLYER -> R.color.ni_success
            AnalyticsSource.FACEBOOK -> R.color.ni_accent
        }
